...
export const getOrderStat = createAsyncThunk(
    'order/orderStat', async()=>{
        const response = await userRequest.get('/order/orderStat'); 
        return response.data; 
    }
)

export const getOrderIncome = createAsyncThunk(
    'order/createOrderIncome',async()=>{
...
export const getOrderCompareStat =  createAsyncThunk(
    'order/getOrderCompare', async()=>{
...
export const exportToExcel = createAsyncThunk(
    'order/exportToExcel',async(data)=>{
